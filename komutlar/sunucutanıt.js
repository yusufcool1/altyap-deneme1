...
exports.run = async (client, message, args) => {
    ...
    .addField(':warning: Uyarı :warning:', '`ca!sunucutanıt` adlı komutu özel mesajlarda kullanamazsın.')
  ...
  .setTitle('BAŞARILI')
.setDescription('Sunucunuz Başarıyla [Destek Sunucusunda Yani Burada Tanıtıldı](https://discord.gg/fd2JJet).\n12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
        .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('528291517719379979').send(embed)
            });
  ...
  message.channel.send({embed: {
      description: '**SunucuTanıt**\n\nBu Komut Bu Sunucuda 12 Saat İçinde 1 Kere Kullanılmış\n\n**Bu Komutu Sadece 12 Saatte 1 Kez Kullanabilirsiniz**\n\n[Destek Sunucusu](https://https:/discord.gg/fd2JJet)\n[Beni Sunucuna Eklemek İçin Lütfen Tıkla](https://discordapp.com/oauth2/authorize?client_id=523510192919412736&scope=bot&permissions=8)'
            }});
  }
};
